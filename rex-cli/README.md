...
В случае, если ошибка настолько серьёзна, что дальнейшее выполнение функции не имеет смысла, функция может бросить исключение с каким-то сообщением и достойно умереть. Логи нужны для прояснения ситуации.
