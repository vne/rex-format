...
На вход каждой из этих функций подаётся объект, состоящий в настоящий момент из двух полей:

	{
		"data": "данные, много-много данных",
...
Функции import и export возвращают одинаковую структуру данных:
